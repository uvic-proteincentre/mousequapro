...
export class ResultPageComponent implements OnInit,OnDestroy {
  ...
  @Input()
  set resultTermQuery(resultQuery:any){
      this.userQueryResult=resultQuery;
  ...
  ngOnInit() {
		...
		this.queryData=this.userQueryResult;
		...
		this.downloadResultQuery=this.queryResPath+'|NA';
		...
		this.dtOptions = {
			...
			columns: [
				...
				{ 
					...
					render: function (data, type, row) {
						const tempURL ='<a target="_blank" routerLinkActive="active" href="/detailinformation?uniProtKb=' + row["UniProtKB Accession"].trim() + '&resultID=' + detailResFile + '#protein">'+ row["UniProtKB Accession"].trim() + '</a>';
						return tempURL;
					}
				},
				{ 
					...
					render: function (data: any, type: any, row: any, meta) {
						if (row["Peptide Sequence"].trim().length > 0 ){
							...
							const tempURL ='<a target="_blank" routerLinkActive="active" href="/detailinformation?uniProtKb=' + row["UniProtKB Accession"].trim() + '&resultID=' + detailResFile + '#assay"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';
				...
				{ 
					...
					render: function (data, type, row) {
						if ((row["Strain"].trim()).length > 0 && (row["Strain"].trim()) != "NA"){
							...
							const tempURL ='<a target="_blank" routerLinkActive="active" href="/detailinformation?uniProtKb=' + row["UniProtKB Accession"].trim() + '&resultID=' + detailResFile + '#concentration"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';
				...
				{ 
					...
					render: function (data, type, row) {
						if ((row["Gene Expression View"].trim()).length > 0 && (row["Gene Expression View"].trim()) != "No"){
							const tempURL ='<a target="_blank" routerLinkActive="active" href="/detailinformation?uniProtKb=' + row["UniProtKB Accession"].trim() + '&resultID=' + detailResFile + '#genExp">....more</a>';
				...
				{ 
					...
					render: function (data, type, row) {
						if ((row["Mouse Kegg Pathway Name"].trim()).length > 0 && (row["Mouse Kegg Pathway Name"].trim()) != "NA"){
							const tempURL ='<a target="_blank" routerLinkActive="active" href="/detailinformation?uniProtKb=' + row["UniProtKB Accession"].trim() + '&resultID=' + detailResFile + '#pathway"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';
				...
				{ 
					...
					render: function (data, type, row) {
						if ((row["Mouse Go Name"].trim()).length > 0 && (row["Mouse Go Name"].trim()) != "NA"){
							const tempURL ='<a target="_blank" routerLinkActive="active" href="/detailinformation?uniProtKb=' + row["UniProtKB Accession"].trim() + '&resultID=' + detailResFile + '#go"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';
				...
				{ 
					...
					render: function (data, type, row) {
						if ((row["Human Disease Name"].trim()).length > 0 && (row["Human Disease Name"].trim()) != "NA"){
							const tempURL ='<a target="_blank" routerLinkActive="active" href="/detailinformation?uniProtKb=' + row["UniProtKB Accession"].trim() + '&resultID=' + detailResFile + '#disease"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';
				...
				{ 
					...
					render: function (data, type, row) {
						if ((row["Human Drug Bank"].trim()).length > 0 && (row["Human Drug Bank"].trim()) != "NA"){
							const tempURL ='<a target="_blank" routerLinkActive="active" href="/detailinformation?uniProtKb=' + row["UniProtKB Accession"].trim() + '&resultID=' + detailResFile + '#drug"><i class="fa fa-plus-square" aria-hidden="true"></i></a>';							
