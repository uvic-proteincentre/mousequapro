...
def pepbasedInfo(jfinaldata,uniprotpepinfo,proteininfoColname):
	listOfMatrix=['Plasma','Red blood cells','Brain','Skin','Testes','Eye','Heart',\
	'Liver Caudate and Right Lobe','Liver Left Lobe','Lung','Kidney','Ovary','Brown Adipose',\
	'White Adipose','Epididymis','Seminal Vesicles', 'Skeletal Muscle','Spleen','Pancreas','Salivary Gland']
	...
	finalupdatedUniInfo["data"]=updatedUniInfo
	return finalupdatedUniInfo